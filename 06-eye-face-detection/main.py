...
class MainForm(QDialog):
    face_cascade=cv2.CascadeClassifier('06-eye-face-detection/haarcascades/haarcascade_frontalface_default.xml')
    eyes_cascade=cv2.CascadeClassifier('06-eye-face-detection/haarcascades/haarcascade_eye.xml')
    def __init__(self):
        super(MainForm, self).__init__()
        loadUi('06-eye-face-detection/main-form.ui', self)
        self.image=None
